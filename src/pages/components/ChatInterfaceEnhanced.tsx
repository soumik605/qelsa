...
export function ChatInterfaceEnhanced({ 
  ...
  const generateAIResponse = (query: string, jobIds?: string[]): Message => {
    ...
    const relevantJobs = jobIds 
      ? contextJobs.filter(j => jobIds.includes(j.id))
      : contextJobs;
    ...
    if (lowerQuery.includes('skill') && lowerQuery.includes('missing') || lowerQuery.includes('skill gap')) {
      ...
      return {
        ...
        suggestedPrompts: [
          'Create a 2-week learning plan for these skills',
          'Show me online courses for GraphQL',
    ...
    if (lowerQuery.includes('compare') && relevantJobs.length >= 2) {
      return {
        ...
        suggestedPrompts: [
          'Show me detailed comparison with custom weights',
          'What are the career paths for these roles?',
          'Help me prepare for interviews at these companies'
        ]
      };
    }
    ...
    if (lowerQuery.includes('career path') || lowerQuery.includes('career forecast')) {
      ...
      return {
        ...
        suggestedPrompts: [
          ...
          'Show me similar career transitions'
        ]
      };
    }
    ...
    if (lowerQuery.includes('interview') || lowerQuery.includes('prepare')) {
      ...
      return {
        ...
        suggestedPrompts: [
          'Generate sample answers for these questions',
          'Show me coding challenges for this role',
    ...
    if (lowerQuery.includes('match') || lowerQuery.includes('fit') || lowerQuery.includes('score')) {
      ...
      return {
        ...
        suggestedPrompts: [
          'Show me the skills I need to develop',
          'Compare this with other opportunities',
...
What would you like to explore?`,
      suggestedPrompts: [
        `Analyze my fit for ${contextJobs[0]?.title || 'these roles'}`,
        'Compare the top jobs for me',
        'Show me skill gaps for these opportunities',
              ...
              <div className="space-y-4 max-w-2xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {[
                    ...
                    >
                      <span className="text-muted-foreground group-hover:text-neon-cyan transition-colors">
                        {prompt}
                      </span>
                    </button>
                  ))}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 space-y-4">
                    ...
                    {message.enhancedResponse && (
                      <EnhancedAIResponse
                        type={message.enhancedResponse.type}
                        data={message.enhancedResponse.data}
