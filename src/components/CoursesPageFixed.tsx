                ...
                >
                  ...
                  <div className="p-6 space-y-4 flex flex-col flex-grow">
                    ...
                    <div className="flex items-center gap-2 pt-2 mt-auto">
                      <Button 
                        className="flex-1 glass hover:glass-strong border-neon-cyan/30 text-neon-cyan hover:text-neon-cyan"
                        onClick={(e) => {
                          e.stopPropagation();
                      ...
                      <Button
                        size="sm"
                        variant="ghost"
                        className="glass hover:glass-strong border-neon-purple/30 text-neon-purple hover:text-neon-purple px-3"
                        onClick={(e) => {
                          e.stopPropagation();
                          handleAIChatClick(course);
                        }}
                      >
