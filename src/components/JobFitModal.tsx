import { X, CheckCircle, AlertCircle, Star, TrendingUp, Award, BookOpen, PlayCircle, Clock, Users, ExternalLink } from 'lucide-react';
...
const mockFitAnalysis: { [key: string]: JobFitData } = {
  '4': {
    ...
    gaps: [
      ...
      "No technical background in software development",
      "Missing user research and UX design experience"
    ],
    recommendations: [
  ...
  '5': {
    ...
    overallFit: 65,
    strengths: [
      "Analytical mindset perfect for data-driven product decisions",
      "Business background helps understand market dynamics",
      "Project coordination skills translate to product management"
    ],
    gaps: [
      "No e-commerce industry experience",
      "Limited technical knowledge of web/mobile platforms",
      "Lack of experience with agile development processes"
    ],
    recommendations: [
      ...
      <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col">
                ...
                return (
                  <div key={index} className="flex items-center justify-between p-3 rounded-lg border bg-gray-50">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="w-20">
                        <Progress 
                          value={Math.min(skill.userLevel, skill.requiredLevel)} 
                          className="h-2" 
                        />
                      </div>
                    </div>
        ...
        <div className="border-t border-gray-200 p-6 flex items-center justify-between">
          <div className="text-sm text-gray-500">
            Analysis based on your current profile and resume
          </div>
